...
const About = () => {
  return (
    <div class='py-16 lg:pl-60'>
        ...
        <p class='px-10 pt-16 text-2xl text-center'>RIBBIT-RIDICULOUS ADVENTURES <wbr/> AWAIT WITH XERXES THE XOOPER!</p>
        <p class='px-10 pt-3 pb-16 text-2xl text-center'>CROAK WITN LAUGHTER. AND JOIN <wbr/> THE FROG OWNED BY GROK!</p>
    </div>
  )
}
